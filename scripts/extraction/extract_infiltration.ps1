$INPUT_DIR = "C:\Users\Student\cicids2018\Thursday-01-03-2018\pcap"
$OUTPUT_DIR = "c:\Users\Student\.gemini\antigravity\scratch\sarvesh-project\extracted_features\Thursday-01-03-2018"
...
Write-Host "Starting Infiltration Extraction for $($all_files.Count) files..."
...
Write-Host "Infiltration Extraction Complete."
