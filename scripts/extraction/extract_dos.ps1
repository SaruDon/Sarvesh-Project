$INPUT_DIR = "C:\Users\Student\cicids2018\Thursday-15-02-2018\pcap"
$OUTPUT_DIR = "c:\Users\Student\.gemini\antigravity\scratch\sarvesh-project\extracted_features\Thursday-15-02-2018"
...
Write-Host "Starting DoS Extraction for $($all_files.Count) files..."
...
Write-Host "DoS Extraction Complete."
