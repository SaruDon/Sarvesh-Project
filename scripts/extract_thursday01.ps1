# extract_thursday01.ps1
# Extracts tshark network features from Thursday-01-03-2018 raw PCAP files
# Reads from cicids2018/Thursday-01-03-2018/ after pcap.zip is extracted
# Outputs CSVs to extracted_features/Thursday-01-03-2018/
# Includes cap* AND UCAP* files. Skips already-done CSVs.

$tshark  = "C:\Program Files\Wireshark\tshark.exe"
$srcBase = "C:\Users\Student\cicids2018\Thursday-01-03-2018"
$outBase = "c:\Users\Student\.gemini\antigravity\scratch\sarvesh-project\extracted_features\Thursday-01-03-2018"
...
Write-Host "Found $($candidates.Count) PCAP candidates in Thursday-01" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "=== Thursday-01 Extraction Complete ===" -ForegroundColor Cyan
